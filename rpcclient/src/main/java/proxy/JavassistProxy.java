...
public class JavassistProxy extends AbstractProxy{
    ...
    public String makeMethodSrc(){
        ...
        String rpcExceptionRef = "exception.RpcException";
        String rpcErrorRef = "enumeration.RpcError";
    ...
    public <T> T getProxy(Class<T> clazz) throws Exception {
        ...
        CtField clientField0 = new CtField(clientCc,"client",mctc);
        ...
        CtField clientField1 = new CtField(clientCc,"invoker",mctc);
